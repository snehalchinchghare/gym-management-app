...
export class CandidateRegisterComponent implements OnInit {
                    ...
                    if (this.isRenew || this.isBalancePayment) {
                        this.supabaseService.getCandidateForRenewal(this.candidateId).then(result => {
                            if (result) {
                                ...
                                const monthsToAdd = this.packageList.find(p => p.packagename.toLowerCase() === selectedPackage.packagename.toLowerCase()).duration_months;
    ...
    async updateCandidateDetails(formData: any) {
        const candidateData = {
        ...
        if (result.success) {
            ...
            this.toast.success('Success', 'Membership added successfully');
